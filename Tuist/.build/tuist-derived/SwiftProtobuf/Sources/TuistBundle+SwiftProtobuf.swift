...
/// Since SwiftProtobuf is a staticFramework, the bundle containing the resources is copied into the final product.
...
@objc
public class SwiftProtobufResources: NSObject {
