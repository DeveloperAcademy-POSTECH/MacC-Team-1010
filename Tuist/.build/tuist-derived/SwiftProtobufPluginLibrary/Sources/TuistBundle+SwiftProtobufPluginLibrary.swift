...
/// Since SwiftProtobufPluginLibrary is a staticFramework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "SwiftProtobuf_SwiftProtobufPluginLibrary"
    ...
    fatalError("unable to find bundle named SwiftProtobuf_SwiftProtobufPluginLibrary")
}()
}
...
@objc
public class SwiftProtobufPluginLibraryResources: NSObject {
